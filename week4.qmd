...
sliderInput("pncp","Non-centrality Parameter (ncp)",min=0,max=10,value=0, step=1, animate = F)
```
...
#| panel: sidebar
library(shiny)
sliderInput("ea","Hits",min=0,max=100,value=.5, step = .5, animate=F)
sliderInput("eb","Misses",min=0,max=100,value=.5, step=.5, animate=F)
sliderInput("encp","Non-centrality Parameter (ncp)",min=0,max=10,value=0, step=1, animate = F)
```
