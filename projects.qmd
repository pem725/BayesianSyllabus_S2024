...
Find, create, simulate, or imagine (and then simulate) a dataset that has repeated measures for at least three people. Compute the gain in accuracy and precision from using a shrunken estimator in predicting future scores.
:::
