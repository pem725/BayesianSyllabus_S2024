...
::: {.callout-important title="Pull the latest changes from GitHub (5 mins max)"}
...
::: {.callout-tip title="Read the assigned readings (before Tuesday each week; 4 hours max/week)"}
...
::: {.callout-note title="Write down your questions from the assigned readings"}
...
::: {.callout-note title="Work on the weekly assignment (before Thursday each week; 4 hours max/week)"}
